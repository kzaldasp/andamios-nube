...
export const MARCADORES_PAGARE = [
  ...
  ['tabla_articulos', 'Tabla con las piezas, su tarifa y el valor de reposición'],
  ['total_reposicion', 'Suma total de los valores de reposición'],
...
function paginaCompleta(titulo, cuerpo) {
  return `<!DOCTYPE html>
...
export async function paginaPagare(alqId, plantillaForzada) {
  ...
  const valores = {
    ...
    total_reposicion: dinero(totalReposicion),
