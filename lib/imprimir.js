...
<p>Me comprometo a <strong>devolver los bienes en buen estado</strong> y a pagar el valor del alquiler acumulado según la tarifa diaria indicada (se cobra de lunes a ${alq.cobra_sabado ? 'sábado' : 'viernes'}; los domingos no se cobran${alq.cobrar_primer_dia ? '' : '; el día de entrega de los bienes no se cobra'}). En caso de pérdida, daño o no devolución de los bienes, me obligo a pagar incondicionalmente el valor de reposición indicado, sin necesidad de requerimiento judicial previo.</p>
